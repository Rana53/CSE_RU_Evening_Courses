        ...
        res.status(200).json({
            ...
            availableCourses: docs.map(doc =>{
                return{
                    ...
                    request: {
                        type: 'GET',
                        url: 'http://localhost:3000/EveningCourses/AvailableCourses/' + doc._id
                    }
                }
            })
        });
...
router.post("/",(req,res,next) => {
    ...
    .then(result => {
        ...
        res.status(200).json({
            ...
            request: {
                type: 'POST',
                url: 'http://localhost:3000/EveningCourses/AvailableCourses/'+ result._id
            }
        });
    })
    .catch(err =>{
...
router.patch("/:courseId",(req,res,next) => {
    ...
    .then(result =>{
        ...
        res.status(500).json({
            ...
            request: {
                type: 'POST',
                url: 'http://localhost:3000/EveningCourses/AvailableCourses/'+id
            }
        });
    })
    .catch(err =>{
